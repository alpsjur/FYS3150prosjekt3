...
plotDatavsMCS(ax[0], path, "EMvsMCS_ordered_1.bin", 2)
plotDatavsMCS(ax[0], path, "EMvsMCS_unordered_1.bin", 2)

plotDatavsMCS(ax[0], path, "EMvsMCS_ordered_24.bin", 2)
plotDatavsMCS(ax[0], path, "EMvsMCS_unordered_24.bin", 2)
